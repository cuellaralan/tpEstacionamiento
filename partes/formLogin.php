...
if(!isset($_SESSION['registrado'])){  ?>
    <div id="formLogin" class="container">
      ...
      <form  class="form-ingreso " onsubmit="validarLogin();return false;">
        ...
        <input type="button" onclick="CargarInput('admin@admin.com')" value="ADMINISTRADOR"></input>
        <input type="button" onclick="CargarInput('user@user.com')" value="USUARIO" ></input> 
      </form>
