...
<div id="pagewrap">
	...
	<header id="header">
		...
		<nav>
			<ul id="main-nav" class="clearfix">
				<li><a onclick="Mostrar('MostrarGrilla')" class="btn">Mostrar Grilla<br>-Sesión-</a> </li>
	...
	<div id="content" >
		...
		<article  class="post clearfix">
			...
			<header  >
				<h1 class="post-title"><a href="#">Ejemplos de ajax</a></h1>
	...
	<aside id="sidebar">
		...
		<section class="widget clearfix" >
			<h4 class="widgettitle">informe </h4>
				...
				<br><br>
				<h4 class="widgettitle">facturacion </h4>
				<div id="facturacion">
				<!--contenido dinamico cargado por ajax-->
